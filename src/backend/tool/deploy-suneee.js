...
console.log(options);
(async function() {
    var types = options[3]?[options[3]]:undefined;
    var params = options[4]?[options[4]]:undefined;
    var Contract= await web3sync.rawDeploy(config.account, config.privKey,  filename, types, params);
